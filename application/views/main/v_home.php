			...
			<div class="col-sm-8 content">
				  	...
				  	<!-- Indicators -->
					  	...
					  	<div class="carousel-inner" role="listbox">
					    	<div class="item active">
					      		<img src="<?php echo base_url().'assets/' ?>images/1.png" alt="Chania">
					    	</div>

					    	<div class="item">
					      		<img src="<?php echo base_url().'assets/' ?>images/2.png" alt="Chania">
					    	</div>
				...
				<div class="panel panel-default welcome">
				  	<div class="panel-heading"><i class="glyphicon glyphicon-list-alt"></i> Breita Terbaru</div>
				  	<div class="panel-body">
